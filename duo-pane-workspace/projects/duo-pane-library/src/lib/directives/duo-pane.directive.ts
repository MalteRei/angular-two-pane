import { Directive, Input, ViewContainerRef, EventEmitter, TemplateRef, Output, ComponentRef, ComponentFactoryResolver } from '@angular/core';
import { ISegment, Segment, DuoPaneInformationService } from '../services/duo-pane-information.service';
