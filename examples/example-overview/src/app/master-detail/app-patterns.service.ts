...
export class AppPatternsService {
  ...
  private masterDetailPattern = new AppPattern('Master - detail', ['Hey, is this pattern familiar to you? You have been looking at it the entire time. Master-detail is found across a wide range of applications. You should definitely look at your application to see if you can spot it.','The master-detail pattern has a master pane (usually with a list view) and a details pane for content. When an item in the master list is selected, the details pane is updated. This pattern is naturally good for when you have a wider viewing area. It is frequently used for email and address books.',
