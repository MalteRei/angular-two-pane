...
export class AppPatternsService {
  ...
  private AppPatterns = [this.masterDetailPattern, this.masterDetailPattern, new AppPattern('Test', ['paragraph'], undefined, undefined)];
