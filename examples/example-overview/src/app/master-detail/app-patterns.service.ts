...
export class AppPatternsService {
  ...
  private readonly gettingStarted = new AppPattern('Get started', ['1. To use this library in your Angular application install it from npm (ng add angular-duo-pane)', '2. Then you need to import AngularDuoPaneModule from angular-duo-pane into a module of your application.', '3. Now, you are ready to use the [duoPane] directive.', 'Make sure to have a look at our GitHub repository (https://github.com/MalteRei/angular-two-pane).'], new URL('https://docs.microsoft.com/en-us/dual-screen/images/dual-screen-app-patterns.png'), undefined, undefined);
  ...
  private AppPatterns = [this.gettingStarted, this.playground, this.masterDetailPattern, this.twoPagePattern];

  private SelectedAppPattern: IAppPattern = undefined;
