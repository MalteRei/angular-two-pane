...
export class AppPatternsService {
  ...
  + "Taking advantage of the two distinct screens and snapping to the natural boundary, you could use one screen to show the 'items' list and the other to show details of the selected item.", new URL("https://docs.microsoft.com/en-us/dual-screen/images/master-detail.png"), null)];
